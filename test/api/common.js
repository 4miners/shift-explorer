    ...
    describe('GET /api/getPriceTicker', function() {
        it('should be ok', function(done) {
            getPriceTicker(function(err, res) {
                node.expect(res.body).to.have.property('success').to.be.ok;
                node.expect(res.body).to.have.deep.property('tickers.SHIFT.BTC').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.SHIFT.EUR').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.SHIFT.USD').to.be.a.number;
