...
config.walletAddress = 'https://wallet.shiftnrg.org'; // Link to wallet login
...
config.exchangeRates.exchanges.SHIFT.BTC = 'bittrex';  // LSK/BTC pair, supported: poloniex
